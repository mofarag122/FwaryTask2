public class QuantumBookstoreTest{
    ...
    public static void main(String[] args){
        ...
        Book paper= new PaperBook("ISBN11", "Java Tips", "Mark", 2013, 300, 10);
        Book ebook= new EBook("ISBN22", "Database", "Ramy", 2020, 200, ".pdf");
        ...
        try {
            ...
            amountPaid = inventory.buyBook("ISBN22", 1, "user@example.com", "N/A");
            System.out.println("Quantum book store: paid amount: " + amountPaid);
